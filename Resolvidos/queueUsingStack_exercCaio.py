...
class QueueUsingStacks:
    ...
    """
    def __init__(self):
        self.pilha_principal = Stack()   #Pilha onde inserimos os elementos (aqui é basicamente a mesma base do exercício anterior)
        self.pilha_aux = Stack()         #Pilha auxiliar para remover em ordem
    ...
    def dequeue(self):
        ...
        if self.pilha_aux.is_empty():
            #Se a pilha auxiliar está vazia, passamos todos da principal para ela
